...
function Content({ isEditing, useNodeMemory }) {
  ...
  return (
    <>
      ...
      {/* <Environment environmentIntensity={1.0} files={[`/hdr/default.hdr`]}></Environment> */}
...
//   let moveData = useNodeMemory((r) => r[name]) || new Matrix4().identity().toArray()
...
//   return isEditing && moveData && gizmo && process.env.NODE_ENV === 'development' ? (
//     <PivotControls
//       matrix={m4}
//       scale={10}
//       onDrag={(ev) => {
...
//       <Center>
//         <Html distanceFactor={5} position={[1.25, 0.0, -0.35]} className=' z-50'>
//           <div
...
//             <InputRange name={`intensity`} max={500} useNodeMemory={useNodeMemory}></InputRange>
//             <InputColor name={`lightColor`} useNodeMemory={useNodeMemory}></InputColor>
//           </div>
//         </Html>
//       </Center>
//     </group>
