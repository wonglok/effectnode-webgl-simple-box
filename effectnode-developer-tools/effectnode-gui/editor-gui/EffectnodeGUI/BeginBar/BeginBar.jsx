      ...
      <div className="w-full h-full flex items-center justify-between text-sm">
        ...
        <div className="flex justify-start">
          <div
            ...
            className="bg-white rounded-full overflow-hidden w-20 h-9 m-1 px-4 flex items-center justify-center cursor-pointer"
          >
            <img
              className="fill-white h-full bg-white select-none"
              src={icon.src}
            ></img>
          </div>
